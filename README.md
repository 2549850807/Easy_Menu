...
>>>>>>> cb2208591e8b690bd0357cd1aa0dfdcbb248638c
...
> 框架本身占用：3.76KB
>
> 每增加一个页面约占用590字节ROM、150字节RAM
>
> 每增加一个条目约占用176字节ROM、45字节RAM
...
- **数据格式**：JSON（配置文件）
- **代码生成**：基于模板的代码生成器，支持类 STM32CubeMX 的增量更新
